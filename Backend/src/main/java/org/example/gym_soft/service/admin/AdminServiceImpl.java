...
import org.example.gym_soft.entity.*;
import org.example.gym_soft.entity.wrapper.GymReportResponse;
import org.example.gym_soft.projection.GymUsersProjection;
import org.example.gym_soft.projection.UserHistoryRateProjection;
import org.example.gym_soft.projection.UserRateProjection;
...
import org.example.gym_soft.repository.*;
...
public class AdminServiceImpl implements AdminService {
  ...
  final UserRateRepo userRateRepo;
  final UserRateDayRepo userRateDayRepo;
...
//            .startTime(LocalDate.now()).endTime(LocalDate.now().plusDays(rate.getEveryDay()))
